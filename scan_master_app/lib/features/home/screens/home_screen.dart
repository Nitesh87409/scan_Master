    ...
    try {
      ...
      if (files.isNotEmpty) {
        ...
        if (isGallery) {
          ...
          AnalyticsEvents.logScanDocument();
        }
      }
    } catch (e) {
      ...
      child: Scaffold(
        appBar: AppBar(
          leading: _currentIndex != 0
              ...
              : null,
          title: Text('Scan Master', style: TextStyle(fontWeight: FontWeight.bold)),
          actions: [
            IconButton(
            ...
            IconButton(
              ...
              tooltip: AppLocalizations.of(context)!.titleTrashBin,
              onPressed: () {
                Navigator.push(
                  context,
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                SizedBox(width: 6),
                Text(
                  AppLocalizations.of(context)!.badgePrivacy,
                  style: TextStyle(
                    fontSize: 12,
                ...
                Row(
                  children: [
                    Expanded(
                      child: _buildActionCard(
                        context,
                        AppLocalizations.of(context)!.protectPdfTitle,
                                      ...
                                      if (_pinnedFiles.contains(file.path))
                                        Positioned(
                                          ...
                                          child: Container(
                                            ...
                                            child: Icon(Icons.push_pin, size: 12, color: Colors.purple),
                                          ),
                                        ),
                                    ],
                                  ),
