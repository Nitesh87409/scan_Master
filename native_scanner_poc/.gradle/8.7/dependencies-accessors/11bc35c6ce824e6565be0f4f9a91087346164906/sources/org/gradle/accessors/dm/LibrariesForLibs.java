...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxCameraLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>compose</b> with <b>androidx.camera:camera-compose</b> coordinates and
         * with version reference <b>cameraCompose</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCompose() {
            return create("androidx.camera.compose");
        }
    ...
    public static class MlkitLibraryAccessors extends SubDependencyFactory {
        private final MlkitSubjectLibraryAccessors laccForMlkitSubjectLibraryAccessors = new MlkitSubjectLibraryAccessors(owner);

        public MlkitLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>mlkit.subject</b>
         */
        public MlkitSubjectLibraryAccessors getSubject() {
            return laccForMlkitSubjectLibraryAccessors;
        }

    }

    public static class MlkitSubjectLibraryAccessors extends SubDependencyFactory {

        public MlkitSubjectLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>segmentation</b> with <b>com.google.android.gms:play-services-mlkit-subject-segmentation</b> coordinates and
         * with version reference <b>mlkitSubjectSegmentation</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getSegmentation() {
            return create("mlkit.subject.segmentation");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>cameraCompose</b> with value <b>1.5.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCameraCompose() { return getVersion("cameraCompose"); }

        /**
         * Version alias <b>camerax</b> with value <b>1.5.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>mlkitSubjectSegmentation</b> with value <b>16.0.0-beta1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMlkitSubjectSegmentation() { return getVersion("mlkitSubjectSegmentation"); }
